function [ax, data] = lvmScatterPlotNoVar2(model, YLbls, ax, dims, defaultVals, figHandle)

% Just a Temporary replacement for lvmScatterPlotNoVar, here we just use
% our own symbols...
  if nargin < 5
